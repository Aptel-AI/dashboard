    ...
    if (sm) {
      ...
      const kpis = isFios
        ...
        ? (() => {
            ...
            const resAvgUnits = activeHC > 0 ? Math.round(resTotalUnits / activeHC * 10) / 10 : '—';
            return [
      ...
      if (isB2B) {
        ...
        const dailyDays = da.filter(d => d.day !== 'Week Avg');

        const b2bScoringHC = (s.reps || []).filter(r => (r.totalVolume || 0) > 0).length;
        const b2bProductiveHC = (s.reps || []).filter(r => (r.totalVolume || 0) >= 6).length;
        const activeHC2 = owner.headcount?.active || 0;
        const b2bAvgUnits = activeHC2 > 0 ? Math.round((sm.totalVolume || 0) / activeHC2 * 10) / 10 : '—';
        ...
        // Saturday card is temporary — date-gated, auto-hides after 2026-04-13
        const mcoe = s.mcoeSales;
        const _showSat = new Date() < new Date('2026-04-14');
        const _satTotal = { pct: 52, opptSales: 290, opptLost: 63826, annLost: 3318954 };
        const _satRows = [
          { rank:  1, name: 'Kinsey Guenther',        pct: 105, opptSales:  0, opptLost:     0, annLost:       0 },
          { rank:  2, name: 'Luke Baldwin',            pct: 102, opptSales:  0, opptLost:     0, annLost:       0 },
          { rank:  3, name: 'Ryan Kabbes',             pct: 91,  opptSales:  0, opptLost:     0, annLost:       0 },
          { rank:  4, name: 'Joey Ramirez',            pct: 85,  opptSales:  0, opptLost:     0, annLost:       0 },
          { rank:  5, name: 'Gary Whitaker II',        pct: 84,  opptSales:  0, opptLost:     0, annLost:       0 },
          { rank:  6, name: 'Blake Welle',             pct: 78,  opptSales:  0, opptLost:     0, annLost:       0 },
          { rank:  7, name: 'Aaron Corso',             pct: 78,  opptSales:  0, opptLost:     0, annLost:       0 },
          { rank:  8, name: 'Luis Salazar',            pct: 76,  opptSales:  1, opptLost:   188, annLost:    9781 },
          { rank:  9, name: 'Tessa Lopez',             pct: 74,  opptSales:  1, opptLost:   120, annLost:    6244 },
          { rank: 10, name: 'Max Powell',              pct: 70,  opptSales:  1, opptLost:   296, annLost:   15396 },
          { rank: 11, name: 'Alexander Badawi',        pct: 70,  opptSales:  3, opptLost:   620, annLost:   32227 },
          { rank: 12, name: 'Tony McDaniel',           pct: 69,  opptSales:  2, opptLost:   435, annLost:   22594 },
          { rank: 13, name: 'Mitchell Evans',          pct: 68,  opptSales:  1, opptLost:   276, annLost:   14343 },
          { rank: 14, name: 'Jeffrey Starr',           pct: 66,  opptSales:  2, opptLost:   450, annLost:   23423 },
          { rank: 15, name: 'David Munoz',             pct: 65,  opptSales:  3, opptLost:   651, annLost:   33867 },
          { rank: 16, name: 'Shalonda Warren',         pct: 64,  opptSales:  3, opptLost:   591, annLost:   30716 },
          { rank: 17, name: 'Demetrius Pruitt',        pct: 64,  opptSales:  3, opptLost:   550, annLost:   28624 },
          { rank: 18, name: 'Jamis Garay',             pct: 63,  opptSales:  3, opptLost:   614, annLost:   31918 },
          { rank: 19, name: 'Maxwell Scott',           pct: 62,  opptSales:  5, opptLost:  1038, annLost:   53983 },
          { rank: 20, name: 'Sabrina Alicea',          pct: 59,  opptSales:  3, opptLost:   726, annLost:   37733 },
          { rank: 21, name: 'Dylan McCann',            pct: 58,  opptSales:  2, opptLost:   371, annLost:   19291 },
          { rank: 22, name: 'Carlos Hidalgo',          pct: 58,  opptSales: 10, opptLost:  2284, annLost:  118781 },
          { rank: 23, name: 'Ricky Malone',            pct: 57,  opptSales: 14, opptLost:  3142, annLost:  163363 },
          { rank: 24, name: 'Joe Shipman',             pct: 57,  opptSales:  2, opptLost:   491, annLost:   25526 },
          { rank: 25, name: 'Ulysses Guerrero',        pct: 57,  opptSales:  3, opptLost:   610, annLost:   31736 },
          { rank: 26, name: 'Lizette Ruiz-Conejo',     pct: 57,  opptSales:  2, opptLost:   533, annLost:   27737 },
          { rank: 27, name: 'Blaise St Julien',        pct: 56,  opptSales:  2, opptLost:   541, annLost:   28114 },
          { rank: 28, name: 'Eshaunte Williams',       pct: 56,  opptSales:  3, opptLost:   640, annLost:   33267 },
          { rank: 29, name: 'David Pisikian',          pct: 56,  opptSales:  3, opptLost:   584, annLost:   30349 },
          { rank: 30, name: 'Adrian Sarabia',          pct: 54,  opptSales:  3, opptLost:   599, annLost:   31150 },
          { rank: 31, name: 'Jacob Dunlavy',           pct: 54,  opptSales:  2, opptLost:   536, annLost:   27880 },
          { rank: 32, name: 'Gregory Halstead',        pct: 53,  opptSales:  4, opptLost:   925, annLost:   48091 },
          { rank: 33, name: 'Jackie LeRoy',            pct: 53,  opptSales:  6, opptLost:  1243, annLost:   64655 },
          { rank: 34, name: 'Diamante Williams',       pct: 51,  opptSales:  1, opptLost:   227, annLost:   11788 },
          { rank: 35, name: 'Darius Sessions',         pct: 49,  opptSales:  1, opptLost:   248, annLost:   12918 },
          { rank: 36, name: 'Justin Wood',             pct: 49,  opptSales:  4, opptLost:   887, annLost:   46141 },
          { rank: 37, name: 'Elijah Golston',          pct: 49,  opptSales:  4, opptLost:   781, annLost:   40612 },
          { rank: 38, name: 'Stefan Cameron',          pct: 48,  opptSales:  2, opptLost:   540, annLost:   28071 },
          { rank: 39, name: 'George Hipolito',         pct: 48,  opptSales:  4, opptLost:   945, annLost:   49154 },
          { rank: 40, name: 'Eveliz Wright',           pct: 47,  opptSales: 11, opptLost:  2524, annLost:  131226 },
          { rank: 41, name: 'Roberto Rodriguez',       pct: 47,  opptSales:  5, opptLost:  1067, annLost:   55484 },
          { rank: 42, name: 'Ellen Dent',              pct: 46,  opptSales:  4, opptLost:   811, annLost:   42190 },
          { rank: 43, name: 'Luna Leung',              pct: 45,  opptSales:  5, opptLost:  1033, annLost:   53720 },
          { rank: 44, name: 'Logan McBride',           pct: 44,  opptSales: 10, opptLost:  2161, annLost:  112360 },
          { rank: 45, name: 'Kevin Driggs',            pct: 44,  opptSales:  8, opptLost:  1662, annLost:   86405 },
          { rank: 46, name: 'Joshua Murphy',           pct: 41,  opptSales:  3, opptLost:   700, annLost:   36403 },
          { rank: 47, name: 'Dhyey Patel',             pct: 40,  opptSales:  4, opptLost:   951, annLost:   49440 },
          { rank: 48, name: 'Cruz Venegas',            pct: 39,  opptSales:  9, opptLost:  1989, annLost:  103422 },
          { rank: 49, name: 'Alex Censi',              pct: 33,  opptSales:  2, opptLost:   510, annLost:   26498 },
          { rank: 50, name: 'Joseph Eckhart',          pct: 32,  opptSales: 11, opptLost:  2520, annLost:  131055 },
          { rank: 51, name: 'Taylor Blayde',           pct: 32,  opptSales:  4, opptLost:   819, annLost:   42571 },
          { rank: 52, name: 'Ryleigh Zahn',            pct: 32,  opptSales:  4, opptLost:   934, annLost:   48549 },
          { rank: 53, name: 'Devin Hokanson-Smith',    pct: 31,  opptSales: 10, opptLost:  2162, annLost:  112417 },
          { rank: 54, name: 'Ren Fredericks',          pct: 31,  opptSales:  5, opptLost:  1113, annLost:   57891 },
          { rank: 55, name: 'Jesse Knight',            pct: 30,  opptSales:  9, opptLost:  2013, annLost:  104652 },
          { rank: 56, name: 'Brandon Lim',             pct: 29,  opptSales:  3, opptLost:   755, annLost:   39254 },
          { rank: 57, name: 'Tim Ewing',               pct: 28,  opptSales:  3, opptLost:   734, annLost:   38148 },
          { rank: 58, name: 'Jordan Cline',            pct: 26,  opptSales:  2, opptLost:   518, annLost:   26946 },
          { rank: 59, name: 'Cody Lowery',             pct: 26,  opptSales: 18, opptLost:  3858, annLost:  200600 },
          { rank: 60, name: 'Monika Swanson',          pct: 26,  opptSales: 10, opptLost:  2102, annLost:  109290 },
          { rank: 61, name: 'Harman Shamo',            pct: 25,  opptSales:  1, opptLost:   310, annLost:   16097 },
          { rank: 62, name: 'Marvin Williams',         pct: 25,  opptSales:  9, opptLost:  1915, annLost:   99595 },
          { rank: 63, name: 'Josh Rawlins',            pct: 24,  opptSales: 12, opptLost:  2658, annLost:  138190 },
          { rank: 64, name: 'Valeria Tristan',         pct: 20,  opptSales:  5, opptLost:  1074, annLost:   55870 },
          { rank: 65, name: 'Jessica Vihtelic',        pct: 20,  opptSales:  4, opptLost:   974, annLost:   50622 },
          { rank: 66, name: 'Jacques Duncan',          pct: 16,  opptSales:  6, opptLost:  1328, annLost:   69074 },
          { rank: 67, name: 'Nick Chandler',           pct:  4,  opptSales:  6, opptLost:  1237, annLost:   64345 },
          { rank: 68, name: 'Tj Cromer',               pct:  0,  opptSales:  5, opptLost:  1144, annLost:   59498 },
        ];
          ...
          if (_showSat) {
            ...
            _satCardHtml = `
              <div class="coaching-section" style="flex:2;min-width:0;">
                <div class="coaching-label" style="font-size:13px;">Saturday % of Weekday Sales <span style="font-size:9px;font-weight:400;color:var(--silver-dim);margin-left:6px;">Week of 4/6</span></div>
